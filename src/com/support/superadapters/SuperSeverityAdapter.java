    ...
    private void showColorPickerDialogDemo(final int position, final String text) {
        ...
        int initialColor = Integer.valueOf(listItemInfos.get(position).getColor());
            ...
            public void onColorSelected(int color) {
                ...
                etSeverity.clearFocus();
                for (CaseSeverity upd : SuperSeverityActivity.listSeverity) {
                        CaseSeverity cs = new CaseSeverity(upd.getCaseSeverityID(), upd.getCaseSeverityDesc(), upd.getColor());
                        SuperSeverityActivity.listSeverity.set(i, cs);

                    i++;
                }
                CaseSeverity cs = new CaseSeverity(listItemInfos.get(position).getCaseSeverityID(), text, String.valueOf(color));
